...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        livro1 = new Livro("Desenvolvendo seu Primeiro Aplicativo Android", "Luiz Carlos");
        livro2 = new Livro("Programação de Jogos Android", "Edgard B. Damiani");
        livro3 = new Livro("Desenvolvimento de Aplicativos. Um Guia Prático Para Criar Aplicações");
