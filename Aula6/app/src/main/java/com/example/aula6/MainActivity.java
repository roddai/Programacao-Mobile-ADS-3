...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cao1 = new Pet("Pibble", "Verde", "Alien", 20000, "30 de fevereiro");
        cao2 = new Pet("Daddy", "Preto e branco", "Pacificadora", 1, "14 de abril");
        cao3 = new Pet("Silêncio", "Cinza", "Silenciosa", 29, "30 de dezembro");

        gato1 = new Pet("Alma", "Branco", "Meowl", 0, "hoje");
        gato2 = new Pet("Nekoark", "Laranja", "Nekoark", 29, "18 de julho");
        gato3 = new Pet("Khidir Karawita", "Cinza", "Guerreira", 2, "amanhã");
